/**
 * Created by: Kristin Diep
 * Modified by: Sarina Carter (7/12/2018)
 * 
 ...
 **/
 ...
 jsPsych.plugins['iat-html'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0; font-size: 1.6em;'><p id='jspsych-iat-stim'>" + trial.stimulus + "</p></div>";
    ...
    if(trial.display_feedback === true) {
      html_str += "<div id='wrongImgContainer' style='visibility: hidden; position: absolute; top: -100px; margin-left: auto; margin-right: auto; left: 0; right: 0'><p>"+trial.html_when_wrong+"</p></div>";
