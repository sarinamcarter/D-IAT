    var sen4_block1_instructions = {
      type: 'html-keyboard-response',
      stimulus: "<div style='position: absolute; top: 18%; left: 20%'><p>Press E for:<br><strong>Death</strong></p></div>" +
      "<div style='position: absolute; top: 18%; right: 20%'><p>Press I for:<br><strong>Life</strong></p></div><br>" +
      "<div style='position: relative; top: 45%; margin-left: auto; margin-right: auto'>Put a left finger on the <strong>E</strong> key for items that belong to the <strong>Death</strong> category. Put a right finger on the " +
    ...
    var sen4_block2_instructions = {
      ...
      "<div style='position: relative; top: 45%; margin-left: auto; margin-right: auto'>Put a left finger on the <strong>E</strong> key for items that belong to the <strong>Me</strong> category. Put a right finger on the " +
    ...
    var sen4_block5_instructions = {
      type: 'html-keyboard-response',
      stimulus: "<div style='position: absolute; top: 18%; left: 20%'><p>Press E for:<br><strong>Life</strong></p></div>" +
      "<div style='position: absolute; top: 18%; right: 20%'><p>Press I for:<br><strong>Death</strong></p></div><br><br>" +
