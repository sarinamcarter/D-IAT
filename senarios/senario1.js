    ...
    var sen1_block1_instructions = {
      ...
      "for items that belong to the <strong>Death</strong> category. Put a right finger on the " +
      "<strong>I</strong> key for items that belong to the <strong>Life</strong> " +
    ...
    var sen1_block1 = {
      timeline: [
        ...
        on_finish: function() {
          var data = jsPsych.data.getLastTrialData().values();
          },
        },
      ],
      timeline_variables: [
    ...
    var sen1_block2_instructions = {
      type: 'html-keyboard-response',
      stimulus: "<div style='position: absolute; top: 18%; left: 20%'><p>Press E for:<br><strong>Me</strong></p></div>" +
      "<div style='position: absolute; top: 18%; right: 20%'><p>Press I for:<br><strong>Not Me</strong></p></div><br>" +
      "<div style='position: relative; top: 45%; margin-left: auto; margin-right: auto'>Put a left finger on the <strong>E</strong> key " +
      "for items that belong to the <strong>Me</strong> category. Put a right finger on the " +
      "<strong>I</strong> key for items that belong to the <strong>Not Me</strong> " +
      "category. Items will appear one at a time.<br><br>" + "If you " +
      "make a mistake, a red X will appear. Press the keys listed below " +
      "to continue. Go as fast as you can while being accurate.<br><br> " +
      "Press the any key when you are ready to start.</div>",
    ...
    var sen1_block2 = {
      timeline: [
        ...
        response_ends_trial: true,
        data: { iat_type: 'me-notme' }
        }
      ],
      timeline_variables: [
        {stimulus: "They", stim_key_association: "right"},
        {stimulus: "Them", stim_key_association: "right"},
        {stimulus: "Their", stim_key_association: "right"},
        {stimulus: "Theirs", stim_key_association: "right"},
    ...
    var sen1_block3_instructions = {
      type: 'html-keyboard-response',
      stimulus: "<div style='position: absolute; top: 18%; left: 20%'><p>" +
      "Press E for:<br><strong>Life</strong><br> or <br><strong>Me</strong></p></div><br>" +
      "<div style='position: absolute; top: 18%; right: 20%'><p>Press I for:<br><strong>Death</strong><br> or <br><strong>Note Me</strong></p></div><br><br>" +
      ...
      "Press <strong>E</strong> key for items that belong to the <strong>Life</strong> or <strong>Me</strong> categories. Press the " +
      "<strong>I</strong> key for items that belong to the <strong>Death</strong> or <strong>Not Me</strong> " +
    ...
    var sen1_block3 = {
      timeline: [
        ...
        left_category_key: 'E',
        right_category_key: 'I',
        left_category_label: ['Life', 'Me'],
        right_category_label: ['Death', 'Not Me'],
        response_ends_trial: true,
        data: { iat_type: 'life/me-death/notme' }
        }
      ],
      timeline_variables: [
        {stimulus: "Die", stim_key_association: "right"},
    ...
    var sen1_block4_instructions = {
      type: 'html-keyboard-response',
      stimulus: "<div style='position: absolute; top: 18%; left: 20%'><p>" +
      "Press E for:<br><strong>Life</strong><br> or <br><strong>Me</strong></p></div>" +
      "<div style='position: absolute; top: 18%; right: 20%'><p>Press I for:<br><strong>Death</strong><br> or <br><strong>Not Me</strong></p></div><br><br>" +
      "<div style='position: relative; top: 45%; margin-left: auto; margin-right: auto'>Sort the same four categories again. " +
      "Press <strong>E</strong> key for items that belong to the <strong>Life</strong> or <strong>Me</strong> categories. Press the " +
      "<strong>I</strong> key for items that belong to the <strong>Death</strong> or <strongNot Me</strong> " +
      "categories. Items will appear one at a time.<br><br>" + "If you " +
      "make a mistake, a red X will appear. Press the keys listed below " +
      "to continue. Go as fast as you can while being accurate.<br><br> " +
      "Press the any key when you are ready to start.</div>",
    ...
    var sen1_block5_instructions = {
      ...
      "Put a left finger on the <strong>E</strong> key for items that belong to the <strong>Death</strong> category. Put a right finger on the " +
      "<strong>I</strong> key for items that belong to the <strong>Life</strong> " +
      "category. Items will appear one at a time.<br><br>" + "If you " +
      "make a mistake, a red X will appear. Press the keys listed below " +
      "to continue. Go as fast as you can while being accurate.<br><br> " +
    ...
    var sen1_block6_instructions = {
      type: 'html-keyboard-response',
      stimulus: "<div style='position: absolute; top: 18%; left: 20%'><p>" +
      "Press E for:<br><strong>Death</strong><br> or <br><strong>Me</strong></p></div>" +
      "<div style='position: absolute; top: 18%; right: 20%'><p>Press I for:<br><strong>Life</strong><br> or <br><strong>Not Me</strong></p></div><br><br>" +
      ...
      "Press <strong>E</strong> key for items that belong to the <strong>Death</strong> or <strong>Me</strong> categories. Press the " +
      "<strong>I</strong> key for items that belong to the <strong>Life</strong> or <strong>Not Me</strong> " +
      "categories. Items will appear one at a time.<br><br>" + "If you " +
      "make a mistake, a red X will appear. Press the keys listed below " +
      "to continue. Go as fast as you can while being accurate.<br><br> " +
      "Press the any key when you are ready to start.</div>",
    ...
    var sen1_block6 = {
      timeline: [
        ...
        left_category_key: 'E',
        right_category_key: 'I',
        left_category_label: ['Death', 'Me'],
        right_category_label: ['Life', 'Not Me'],
        response_ends_trial: true,
        data: { iat_type: 'death/me-life/notme' }
        }
      ],
      timeline_variables: [
        {stimulus: "Die", stim_key_association: "left"},
