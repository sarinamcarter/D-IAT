    ...
    var sen3_block2_instructions = {
      ...
      "for items that belong to the <strong>Not Me</strong> category. Put a right finger on the " +
    ...
    var sen3_block4 = {
      timeline: [
        ...
        right_category_label: ['Life', 'Me'],
        response_ends_trial: true,
        data: { iat_type: 'deat/notme-life/me' }
        }
      ],
      timeline_variables: [
        {stimulus: "Die", stim_key_association: "left"},
